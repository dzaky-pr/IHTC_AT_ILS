...
public class IHTP_SA {
    ...
    public void run() {
        ...
        evaluateFull(currentState);
        System.out.println(
                "Initial Cost calculated: Soft=" + currentState.softCost + ", Hard=" + currentState.hardViolations);
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out
                    .println("  2. java IHTP_SA <input.json> <max_hours> <log.csv> <output_sol.json> [input_sol.json]");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
